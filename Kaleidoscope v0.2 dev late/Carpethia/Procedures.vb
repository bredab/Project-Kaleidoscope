...
Public Partial Class MainForm
	...
	Sub Saveparams(path As String)
        Using sw As StreamWriter = File.CreateText(path)
            ...
            sw.WriteLine("108:"+Convert.ToString(waveupdown2.Value))
	...
	Public sub wave_calculation1(rad As Integer)
        ...
        for y = frame to -frame Step zoom
            for x = frame to -frame Step zoom
                ...
                Select Case mode
                	Case 0
	                	z = ( Math.cos((s)/(fact1)) + Math.cos((t)/(fact2)) ) / 2
                	Case 1
	                	z = Math.Abs( Math.cos(s/fact1) + Math.cos(t/fact2) ) / 2
                	Case 2
	                	z = ( Math.Abs(Math.cos(s/fact1)) + Math.Abs(Math.cos(t/fact2)) ) / 2
                	Case 3
	                	z = Math.Sqrt(Math.Abs( Math.cos(s/fact1) + Math.cos(t/fact2) ) / 2)
                	Case 4
	                	z = ( Math.Sqrt(Math.Abs(Math.cos(s/fact1))) + Math.Sqrt(Math.Abs(Math.cos(t/fact2))) ) / 2
                	Case 5
	                	z = ( Math.cos(s/fact1) - Math.cos(t/fact2) ) / 2
                	Case 6
	                	z = Math.Abs( Math.cos(s/fact1) - Math.cos(t/fact2) ) / 2
                	Case 7
	                	z = Math.Sqrt(Math.Abs( Math.cos(s/fact1) - Math.cos(t/fact2) ) / 2)
	                Case 8
	                	z = Math.cos(s/fact1) * Math.cos(t/fact2)
                	Case 9
                		z = Math.Abs( Math.cos(s/fact1) * Math.cos(t/fact2) )
                	Case 10
