...
Partial Class MainForm
	...
	Private Sub InitializeComponent()
		...
		Me.waveupdown.DecimalPlaces = 2
		Me.waveupdown.Maximum = New Decimal(New Integer() {400, 0, 0, 0})
		Me.waveupdown.Minimum = New Decimal(New Integer() {1, 0, 0, 0})
		Me.waveupdown.Name = "waveupdown"
		Me.waveupdown.Value = New Decimal(New Integer() {30, 0, 0, 0})
		...
		Me.wavebar.Maximum = 400
		Me.wavebar.Minimum = 1
		Me.wavebar.Name = "wavebar"
		Me.wavebar.TickFrequency = 20
		Me.wavebar.Value = 30
		...
		Me.cb_brushbase.Items.AddRange(New Object() {resources.GetString("cb_brushbase.Items"), resources.GetString("cb_brushbase.Items1")})
		...
		Me.wavestep_ud.DecimalPlaces = 2
		Me.wavestep_ud.Increment = New Decimal(New Integer() {1, 0, 0, 131072})
		Me.wavestep_ud.Maximum = New Decimal(New Integer() {10, 0, 0, 0})
		Me.wavestep_ud.Minimum = New Decimal(New Integer() {1, 0, 0, 131072})
		Me.wavestep_ud.Name = "wavestep_ud"
		Me.wavestep_ud.Value = New Decimal(New Integer() {1, 0, 0, 0})
		AddHandler Me.wavestep_ud.ValueChanged, AddressOf Me.Wavestep_udValueChanged
		'
		'label10
		'
		...
		Me.wavepanel.Controls.Add(Me.trackBar1)
		...
		Me.trackBar1.BackColor = System.Drawing.Color.FromArgb(CType(CType(192,Byte),Integer), CType(CType(255,Byte),Integer), CType(CType(192,Byte),Integer))
		...
		Me.ud_resolution.Minimum = New Decimal(New Integer() {100, 0, 0, 0})
	...
	Private waveupdown2 As System.Windows.Forms.NumericUpDown
	...
	Private ud_resolution As System.Windows.Forms.NumericUpDown
